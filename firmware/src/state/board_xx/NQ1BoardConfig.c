...
const tBoardConfig NQ1BoardConfig = {
    ...
    .DIOChannels = {
        .Data = {
            ...
            {PORTS_ID_0, DIO_7_PORT, DIO_7_PIN, PORTS_ID_0, DIO_EN_7_PORT, DIO_EN_7_PIN, false,DRV_OC_INDEX_1,true,OUTPUT_FUNC_OC3,OUTPUT_PIN_RPG1},
            {PORTS_ID_0, DIO_8_PORT, DIO_8_PIN, PORTS_ID_0, DIO_EN_8_PORT, DIO_EN_8_PIN, false,SYS_MODULE_OBJ_INVALID,false,OUTPUT_FUNC_NO_CONNECT},
            {PORTS_ID_0, DIO_9_PORT, DIO_9_PIN, PORTS_ID_0, DIO_EN_9_PORT, DIO_EN_9_PIN, true,SYS_MODULE_OBJ_INVALID,false,OUTPUT_FUNC_NO_CONNECT},
            {PORTS_ID_0, DIO_10_PORT, DIO_10_PIN, PORTS_ID_0, DIO_EN_10_PORT, DIO_EN_10_PIN, false,SYS_MODULE_OBJ_INVALID,false,OUTPUT_FUNC_NO_CONNECT},
            {PORTS_ID_0, DIO_11_PORT, DIO_11_PIN, PORTS_ID_0, DIO_EN_11_PORT, DIO_EN_11_PIN, true,SYS_MODULE_OBJ_INVALID,false,OUTPUT_FUNC_NO_CONNECT},
            {PORTS_ID_0, DIO_12_PORT, DIO_12_PIN, PORTS_ID_0, DIO_EN_12_PORT, DIO_EN_12_PIN, true,SYS_MODULE_OBJ_INVALID,false,OUTPUT_FUNC_NO_CONNECT},
            {PORTS_ID_0, DIO_13_PORT, DIO_13_PIN, PORTS_ID_0, DIO_EN_13_PORT, DIO_EN_13_PIN, false,SYS_MODULE_OBJ_INVALID,false,OUTPUT_FUNC_NO_CONNECT},
