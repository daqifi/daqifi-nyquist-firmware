...
const tBoardConfig NQ1BoardConfig = {
    ...
    .DIOChannels =
    {
        .Data =
        {
            ...
            { DIO_0_PORT, DIO_0_PIN, DIO_EN_0_PORT, DIO_EN_0_PIN, false, true},
#endif
            { DIO_1_PORT, DIO_1_PIN, DIO_EN_1_PORT, DIO_EN_1_PIN, true, false},
            { DIO_2_PORT, DIO_2_PIN, DIO_EN_2_PORT, DIO_EN_2_PIN, true, false},
            { DIO_3_PORT, DIO_3_PIN, DIO_EN_3_PORT, DIO_EN_3_PIN, false, true},
            { DIO_4_PORT, DIO_4_PIN, DIO_EN_4_PORT, DIO_EN_4_PIN, true, true},
            { DIO_5_PORT, DIO_5_PIN, DIO_EN_5_PORT, DIO_EN_5_PIN, false, true},
            { DIO_6_PORT, DIO_6_PIN, DIO_EN_6_PORT, DIO_EN_6_PIN, true, true},
            { DIO_7_PORT, DIO_7_PIN, DIO_EN_7_PORT, DIO_EN_7_PIN, false, true},
            { DIO_8_PORT, DIO_8_PIN, DIO_EN_8_PORT, DIO_EN_8_PIN, false, false},
            { DIO_9_PORT, DIO_9_PIN, DIO_EN_9_PORT, DIO_EN_9_PIN, true, false},
            { DIO_10_PORT, DIO_10_PIN, DIO_EN_10_PORT, DIO_EN_10_PIN, false, false},
            { DIO_11_PORT, DIO_11_PIN, DIO_EN_11_PORT, DIO_EN_11_PIN, true, false},
            { DIO_12_PORT, DIO_12_PIN, DIO_EN_12_PORT, DIO_EN_12_PIN, true, false},
            { DIO_13_PORT, DIO_13_PIN, DIO_EN_13_PORT, DIO_EN_13_PIN, false, false},
            { DIO_14_PORT, DIO_14_PIN, DIO_EN_14_PORT, DIO_EN_14_PIN, true, false},
            { DIO_15_PORT, DIO_15_PIN, DIO_EN_15_PORT, DIO_EN_15_PIN, false, false},
        },
