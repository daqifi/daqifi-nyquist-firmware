 ...
 * (e.g. SD:LISt? "OTHER" then SD:GET "OTHER/f.csv", where OTHER is not the
 * configured directory) still hits the #914 loud-failure path, not this one —
 * restoring that round-trip is #914 Part B, tracked separately.
 *
