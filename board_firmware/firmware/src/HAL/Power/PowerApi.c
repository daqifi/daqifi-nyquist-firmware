            ...
            sPowerWriteVars *pInitVars )
{
    ...
    PLIB_PORTS_PinWrite( \
            PORTS_ID_0, \
            pConfig->EN_5_10V_Ch, \
            pConfig->EN_5_10V_Bit, pWriteVariables->EN_5_10V_Val);
    PLIB_PORTS_PinWrite( \
            PORTS_ID_0, \
...
//    }
    pData->battVoltage = \
            ADC_ConvertToVoltage( &g_BoardData.AInLatest.Data[index] );
