...
const tBoardConfig NQ1BoardConfig = {
    ...
    .DIOChannels = {
        .Data = {
            ...
            {PORTS_ID_0, DIO_4_PORT, DIO_4_PIN, PORTS_ID_0, DIO_EN_4_PORT, DIO_EN_4_PIN, true,DRV_OC_INDEX_2,true,OUTPUT_FUNC_OC4,OUTPUT_PIN_RPF0},
            {PORTS_ID_0, DIO_5_PORT, DIO_5_PIN, PORTS_ID_0, DIO_EN_5_PORT, DIO_EN_5_PIN, false,DRV_OC_INDEX_3,true,OUTPUT_FUNC_OC6,OUTPUT_PIN_RPF1},
            {PORTS_ID_0, DIO_6_PORT, DIO_6_PIN, PORTS_ID_0, DIO_EN_6_PORT, DIO_EN_6_PIN, true,DRV_OC_INDEX_4,true,OUTPUT_FUNC_OC7,OUTPUT_PIN_RPG0},
