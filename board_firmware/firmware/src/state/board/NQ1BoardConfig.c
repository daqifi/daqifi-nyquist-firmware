...
const tBoardConfig NQ1BoardConfig = {
    ...
    .DIOChannels = {
        .Data = {
            {PORTS_ID_0, DIO_0_PORT, DIO_0_PIN, PORTS_ID_0, DIO_EN_0_PORT, DIO_EN_0_PIN, false,DRV_OC_INDEX_0,true},
            {PORTS_ID_0, DIO_1_PORT, DIO_1_PIN, PORTS_ID_0, DIO_EN_1_PORT, DIO_EN_1_PIN, true,SYS_MODULE_OBJ_INVALID,false},
            {PORTS_ID_0, DIO_2_PORT, DIO_2_PIN, PORTS_ID_0, DIO_EN_2_PORT, DIO_EN_2_PIN, true,SYS_MODULE_OBJ_INVALID,false},
            {PORTS_ID_0, DIO_3_PORT, DIO_3_PIN, PORTS_ID_0, DIO_EN_3_PORT, DIO_EN_3_PIN, false,DRV_OC_INDEX_5,true},
            {PORTS_ID_0, DIO_4_PORT, DIO_4_PIN, PORTS_ID_0, DIO_EN_4_PORT, DIO_EN_4_PIN, true,DRV_OC_INDEX_2,true},
            {PORTS_ID_0, DIO_5_PORT, DIO_5_PIN, PORTS_ID_0, DIO_EN_5_PORT, DIO_EN_5_PIN, false,DRV_OC_INDEX_3,true},
            {PORTS_ID_0, DIO_6_PORT, DIO_6_PIN, PORTS_ID_0, DIO_EN_6_PORT, DIO_EN_6_PIN, true,DRV_OC_INDEX_4,true},
            {PORTS_ID_0, DIO_7_PORT, DIO_7_PIN, PORTS_ID_0, DIO_EN_7_PORT, DIO_EN_7_PIN, false,DRV_OC_INDEX_1,true},
            {PORTS_ID_0, DIO_8_PORT, DIO_8_PIN, PORTS_ID_0, DIO_EN_8_PORT, DIO_EN_8_PIN, false,SYS_MODULE_OBJ_INVALID,false},
            {PORTS_ID_0, DIO_9_PORT, DIO_9_PIN, PORTS_ID_0, DIO_EN_9_PORT, DIO_EN_9_PIN, true,SYS_MODULE_OBJ_INVALID,false},
            {PORTS_ID_0, DIO_10_PORT, DIO_10_PIN, PORTS_ID_0, DIO_EN_10_PORT, DIO_EN_10_PIN, false,SYS_MODULE_OBJ_INVALID,false},
            {PORTS_ID_0, DIO_11_PORT, DIO_11_PIN, PORTS_ID_0, DIO_EN_11_PORT, DIO_EN_11_PIN, true,SYS_MODULE_OBJ_INVALID,false},
            {PORTS_ID_0, DIO_12_PORT, DIO_12_PIN, PORTS_ID_0, DIO_EN_12_PORT, DIO_EN_12_PIN, true,SYS_MODULE_OBJ_INVALID,false},
            {PORTS_ID_0, DIO_13_PORT, DIO_13_PIN, PORTS_ID_0, DIO_EN_13_PORT, DIO_EN_13_PIN, false,SYS_MODULE_OBJ_INVALID,false},
            {PORTS_ID_0, DIO_14_PORT, DIO_14_PIN, PORTS_ID_0, DIO_EN_14_PORT, DIO_EN_14_PIN, true,SYS_MODULE_OBJ_INVALID,false},
            {PORTS_ID_0, DIO_15_PORT, DIO_15_PIN, PORTS_ID_0, DIO_EN_15_PORT, DIO_EN_15_PIN, false,SYS_MODULE_OBJ_INVALID,false},  
        },
        .Size = 16,
    },
    .AInModules = {
