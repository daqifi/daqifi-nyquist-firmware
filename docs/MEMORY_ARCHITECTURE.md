...
| Region | Bytes | Source |
|--------|------:|--------|
| Streaming Buffer Pool | 194,560 | Static BSS (`STATIC_POOL_SIZE` = 194KB - 1KB - 512B - 512B - 2KB) |
...
| Sample pool CAPACITY (slots @16ch)¹ | 1,558 | 1,107 | 1,918 | 1,060 |
