...
| 2 | `app_USBDeviceTask` | 3072 | 1290 | Hosts the USB SCPI handler chain, FPU. SCPI callbacks use shared response buffer (see below). **NOT pri 7** — it round-robins with WifiTask at pri 2, below streaming_Task (6). |
